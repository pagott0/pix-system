          ...
          <Card className="p-6">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="description" placeholder="What is this payment for?" />
              </div>
            </div>
          </Card>
          ...
          <Card className="p-6">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground">R$</span>
                  <Input id="contact-amount" type="number" placeholder="0.00" className="pl-10" />
                </div>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-6">
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="scheduled-recipient" placeholder="Recipient's Pix key" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground">R$</span>
                  <Input id="scheduled-amount" type="number" placeholder="0.00" className="pl-10" />
                </div>
              </div>
          ...
          <Card className="p-6">
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground">R$</span>
                  <Input id="split-amount" type="number" placeholder="0.00" className="pl-10" />
                </div>
              </div>

              <div className="space-y-2">
                <Label htmlFor="split-people">Split between</Label>
                <Input id="split-people" type="number" placeholder="Number of people" min="2" />
              </div>
